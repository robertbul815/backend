...
$db['server']['username'] = 'thetrat8_silver';
$db['server']['password'] = '1Nb0yJ%vptSz';
$db['server']['database'] = 'thetrat8_trainapp'; */
$db['server']['hostname'] = 'localhost';
$db['server']['username'] = 'thetrain_silver';
$db['server']['password'] = 'Ue__ecDQ=$Pe';
$db['server']['database'] = 'thetrain_db';
